...
class buy:
    def __init__(self, handle_date_instance, csv_handler):
        ...
        self.original_quantities = {}  # Dictionary to keep track of original quantities
    ...
    def write(self, product_name, quantity, price, expiration_date):
        ...
        for row in data:
            if (
                ...
                if quantity is not None:
                    ...
                    self.original_quantities[product_name] = int(row["Quantity"])  # Keep track of the original quantity
        ...
        data_row = {
            ...
            "Status": "Active"  # New record is active by default
        }
        self.original_quantities[product_name] = quantity  # Keep track of the original quantity
    ...
    def add_to_product_history(self, product_name, quantity, price, date):
        ...
        if not found:
            item = {
                ...
                "Price": price,
                "Date": date,
                "Status": "Active"  # By default, the item is active
            }
